...
public class JDialogEditNauczyciel extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private Nauczyciel editted = null;
	private JTextField textFieldImie;
	private JTextField textFieldNazwisko;
	private JTextField textFieldHaslo;
	private JTextField textFieldLogin;

	public Nauczyciel getEditted() {
		return editted;
	}
	

	public void setEditted(Nauczyciel editted) {
	...
	public static void main(String[] args) {
		try {
			JDialogEditNauczyciel dialog = new JDialogEditNauczyciel();
	 ...
	 * Create the dialog.
	 */
	public JDialogEditNauczyciel() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(JDialogEditNauczyciel.class.getResource("/resources/gdynia-herb.png")));
		setModal(true);
