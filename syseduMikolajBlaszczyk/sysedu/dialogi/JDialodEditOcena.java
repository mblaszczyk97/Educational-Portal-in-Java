...
public class JDialodEditOcena extends JDialog {
	...
	public static void main(String[] args) {
		try {
			JDialodEditOcena dialog = new JDialodEditOcena();
	 ...
	 * Create the dialog.
	 */
	public JDialodEditOcena() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(JDialodEditOcena.class.getResource("/resources/gdynia-herb.png")));
	...
	protected void createOcena() {
		if(isNumeric(getTextFieldOcena().getText())) {
			edited.setOcena(Math.round(Float.valueOf(getTextFieldOcena().getText())));
			edited.setTyp(getTextFieldTyp().getText());
			edited.setKomentarz(getTextAreaKomentarz().getText());
		}else {
			edited.setOcena(24);
			edited.setTyp(getTextFieldTyp().getText());
			edited.setKomentarz(getTextAreaKomentarz().getText());
	...
	public void setEdited(Ocena edited) {
		this.edited = edited;
		getTextFieldOcena().setText(""+edited.getOcena());
		getTextFieldTyp().setText(edited.getTyp());
		getTextAreaKomentarz().setText(edited.getKomentarz());
	}

	public Ocena getEdited() {
		return edited;
	}
