...
public class JDialogAddUczen extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private Uczen created = null;
	private JTextField textFieldImie;
	private JTextField textFieldNazwisko;

	public Uczen getCreated() {
		return created;
	}
	...
	public static void main(String[] args) {
		try {
			JDialogAddUczen dialog = new JDialogAddUczen();
	 ...
	 * Create the dialog.
	 */
	public JDialogAddUczen() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(JDialogAddUczen.class.getResource("/resources/gdynia-herb.png")));
		setModal(true);
	...
	protected void addUczen() {
		created=new Uczen(getTextFieldImie().getText(), getTextFieldNazwisko().getText());
		dispose();
	}
